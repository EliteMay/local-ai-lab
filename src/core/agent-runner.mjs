...
function buildUserPrompt({ role, task, goal, repositoryContext, priorResults, maxPriorResultChars, correction, thinking }) {
...
export class AgentRunner {
  ...
  getLastMeta(taskId) {
    return this.lastMetaByTask.get(taskId) ?? null;
  }
    ...
    for (let attempt = 0; attempt < 2; attempt += 1) {
      ...
      try {
        const request = {
          ...
          jsonSchema: getAgentResponseSchema(role),
