...
contextBridge.exposeInMainWorld("localAI", {
  ...
  getCommandStatus: () => ipcRenderer.invoke("command:status"),
  ...
  loadModel: (modelId) => ipcRenderer.invoke("models:load", modelId),
  unloadModel: (modelId) => ipcRenderer.invoke("models:unload", modelId),
